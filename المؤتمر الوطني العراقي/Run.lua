...
SUDO_USER = redis:hgetall(speed..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(speed..':WELCOME_BOT'),[[▪️ مرحباً انا بوت ]]..redis:get(speed..':NameBot:')..[[ .
▪️ اختـصاصـي حمايـة الـمجموعات
▪️ تأكد من رفعـك للبـوت مشـرف في مجموعـتك واكتب تفعـيل 
قناة سورس سبيد ❥ @SOURCE_SPEED
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/jack1eljoker1/speed2/main/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |V E       |')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/speed2/main/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |V E      |')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/speed2/main/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |V E N   |')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/speed2/main/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/speed2/main/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/speed2/main/plugins/games.lua','./plugins/games.lua')
